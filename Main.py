...
def questionnaire(car_list):
    """
        ...
        Args:
            car_list (list of Vehicle): list of cars in the dealership
        
        Returns:
            adjusted_list (list): List of cars that fit the desires of the
            customer.
...
def main(filepath):
    """Create dealership program that can be run in the command line.
        ...
        Side effects:
            ...
            Prints text to command line including asking for user input.
    ...
    while(running):
        ...
        user_input = input(Fore.MAGENTA + "Do you need help deciding the type of car you want? (y/n) :: " + Fore.WHITE)
        if(user_input == "y"):
