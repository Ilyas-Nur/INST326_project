...
class Dealership:
    ...
    def __init__(self, car_shipment):
        """
            Requires an APR and a car shipment when instatiating the class.
            Assigns attributes.
            
            Args:
                car_shipment (str): see Dealership class documentation
    ...
    def check_holiday(self):
        """
        This method determines whether the current day we're in is close to 
        a holiday: Thanksgiving, Christmas, New Year's depending on the 
        month.
            
        Returns:
            (bool): True or falsoe depending on current's days proximity to
            a holiday.
        """
    ...
    def sell(self, fullname):
        ...
        Side effects:
             - Removes vehicle object from showroom list.
        """
    ...
    def display(self, filtered_list):
        ...
        Args:
            filtered_list (list of Vehicle): list of all vehicles that fit the 
            specified filters.
    ...
    def display_chart(self):
        """Displays the car dealership data into a useful visual plot showing
        car make vs average MSRP.
    ...
    def calculate_msrp(self, vehicle):
        ...
        Args:
            vehicle (Vehicle): vehicle being checked for a holiday discount
        
        Returns:
            (int): Vehicle MSRP, potentially with discount
        """
    ...
    def print_receipt(self, customer):
        ...
        Args:
            customer (Customer): customer who bought the car(s)
            
        Side effects:
             - Creates "receipt.txt" file and writes information including 
            customer attributes to the file.
        """
